...
uint16_t unsigned_exchange_8x8_l4_lamb20000_6(uint16_t i, uint16_t j) {
...
uint16_t z = tmp_z + (part2[7]*pow(2, 8)) + (part3[6]|part4[5])*pow(2, 9) + (part3[7]&part4[6])*pow(2, 10) + (part3[7]|part4[6])*pow(2, 9) + (part4[7]*pow(2, 10));
