...
uint16_t unsigned_exchange_8x8_l2_lamb3000_5(uint16_t i, uint16_t j) {
...
uint16_t z = tmp_z + (part1[5]|part2[5])*pow(2, 7) + (part1[7]&part2[6])*pow(2, 8) + (part1[7]|part2[6])*pow(2, 7) + (part2[7]*pow(2, 8));
