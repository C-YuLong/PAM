...
uint16_t unsigned_exchange_8x8_l2_lamb1000_9(uint16_t i, uint16_t j) {
...
uint16_t z = tmp_z + (part1[6]|part2[4])*pow(2, 6) + (part1[5]|part2[5])*pow(2, 6) + (part1[7]&part2[6])*pow(2, 8) + (part1[7]|part2[6])*pow(2, 7) + (part2[7]*pow(2, 8));
