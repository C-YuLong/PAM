...
uint16_t unsigned_exchange_8x8_l6_lamb5000_7(uint16_t i, uint16_t j) {
...
uint16_t z = tmp_z + (part1[6]|part2[5])*pow(2, 7) + (part1[7]|part2[6])*pow(2, 7) + (part2[7]*pow(2, 8)) + (part3[2]^part4[1])*pow(2, 4) + (part3[6]&part4[5])*pow(2, 8) + (part3[6]|part4[5])*pow(2, 8) + (part3[5]&part4[4])*pow(2, 8) + (part3[5]|part4[4])*pow(2, 7) + (part3[7]&part4[6])*pow(2, 9) + (part3[7]|part4[6])*pow(2, 9) + (part4[7]*pow(2, 10)) + (part5[2]|part6[1])*pow(2, 7) + (part5[4]|part6[3])*pow(2, 8) + (part5[3]|part6[2])*pow(2, 7) + (part5[3]&part6[3])*pow(2, 8) + (part5[6]&part6[5])*pow(2, 10) + (part5[6]|part6[5])*pow(2, 10) + (part5[5]&part6[4])*pow(2, 9) + (part5[5]|part6[4])*pow(2, 9) + (part5[7]&part6[6])*pow(2, 12) + (part5[7]^part6[6])*pow(2, 11) + (part6[7]*pow(2, 12));
